...
from ..models.server_config_custom_transcoding_profile import ServerConfigCustomTranscodingProfile
from ..types import UNSET, Unset
from typing import cast
from typing import Union

if TYPE_CHECKING:
  from ..models.server_config_custom_transcoding_resolutions import ServerConfigCustomTranscodingResolutions
  from ..models.server_config_custom_transcoding_original_file import ServerConfigCustomTranscodingOriginalFile
  from ..models.server_config_custom_transcoding_hls import ServerConfigCustomTranscodingHls
  from ..models.server_config_custom_transcoding_web_videos import ServerConfigCustomTranscodingWebVideos
...
class ServerConfigCustomTranscoding:
    ...
    allow_additional_extensions: Union[Unset, bool] = UNSET
    allow_audio_files: Union[Unset, bool] = UNSET
    threads: Union[Unset, int] = UNSET
    concurrency: Union[Unset, float] = UNSET
    profile: Union[Unset, ServerConfigCustomTranscodingProfile] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        original_file: Union[Unset, dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_original_file,  Unset):
            ...
            original_file = ServerConfigCustomTranscodingOriginalFile.from_dict(_original_file)
        ...
        profile: Union[Unset, ServerConfigCustomTranscodingProfile]
        ...
        resolutions: Union[Unset, ServerConfigCustomTranscodingResolutions]
        if isinstance(_resolutions,  Unset):
            resolutions = UNSET
        else:
            resolutions = ServerConfigCustomTranscodingResolutions.from_dict(_resolutions)




        _web_videos = d.pop("web_videos", UNSET)
        web_videos: Union[Unset, ServerConfigCustomTranscodingWebVideos]
        ...
        hls: Union[Unset, ServerConfigCustomTranscodingHls]

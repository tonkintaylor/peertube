...
class VideoFile:
    ...
    magnet_uri: Union[Unset, str] = UNSET
    resolution: Union[Unset, 'VideoResolutionConstant'] = UNSET
    size: Union[Unset, int] = UNSET
    torrent_url: Union[Unset, str] = UNSET
    torrent_download_url: Union[Unset, str] = UNSET
    file_url: Union[Unset, str] = UNSET
    playlist_url: Union[Unset, str] = UNSET
    file_download_url: Union[Unset, str] = UNSET
    ...
    storage: Union[Unset, FileStorage] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resolution: Union[Unset, VideoResolutionConstant]
        ...
        storage: Union[Unset, FileStorage]

...
if TYPE_CHECKING:
  from ..models.post_api_v1_runners_jobs_request_response_200_available_jobs_item import PostApiV1RunnersJobsRequestResponse200AvailableJobsItem
...
class PostApiV1RunnersJobsRequestResponse200:
    ...
    available_jobs: Union[Unset, list['PostApiV1RunnersJobsRequestResponse200AvailableJobsItem']] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.post_api_v1_runners_jobs_request_response_200_available_jobs_item import PostApiV1RunnersJobsRequestResponse200AvailableJobsItem
        available_jobs: Union[Unset, list[dict[str, Any]]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for available_jobs_item_data in (_available_jobs or []):
            available_jobs_item = PostApiV1RunnersJobsRequestResponse200AvailableJobsItem.from_dict(available_jobs_item_data)

...
from ..models.automatic_tag_available_available_item_type import AutomaticTagAvailableAvailableItemType
from ..types import UNSET, Unset
...
class AutomaticTagAvailableAvailableItem:
    ...
    type_: Union[Unset, AutomaticTagAvailableAvailableItemType] = UNSET

...
if TYPE_CHECKING:
  from ..models.server_config_custom_cache_previews import ServerConfigCustomCachePreviews
  from ..models.server_config_custom_cache_captions import ServerConfigCustomCacheCaptions
...
class ServerConfigCustomCache:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        captions: Union[Unset, dict[str, Any]] = UNSET

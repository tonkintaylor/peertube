...
if TYPE_CHECKING:
  from ..models.add_video_channel_response_200_video_channel import AddVideoChannelResponse200VideoChannel
...
class AddVideoChannelResponse200:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.add_video_channel_response_200_video_channel import AddVideoChannelResponse200VideoChannel
        video_channel: Union[Unset, dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_video_channel,  Unset):
            ...
            video_channel = AddVideoChannelResponse200VideoChannel.from_dict(_video_channel)

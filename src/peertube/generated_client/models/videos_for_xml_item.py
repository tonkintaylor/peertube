...
if TYPE_CHECKING:
  ...
  from ..models.videos_for_xml_item_mediathumbnail import VideosForXMLItemMediathumbnail
  ...
  from ..models.videos_for_xml_item_mediacommunity import VideosForXMLItemMediacommunity
...
class VideosForXMLItem:
    ...
    pub_date: Union[Unset, datetime.datetime] = UNSET
    description: Union[Unset, str] = UNSET
    contentencoded: Union[Unset, str] = UNSET
    dccreator: Union[Unset, str] = UNSET
    mediacategory: Union[Unset, int] = UNSET
    ...
    mediatitle: Union[Unset, str] = UNSET
    mediadescription: Union[Unset, str] = UNSET
    mediarating: Union[Unset, VideosForXMLItemMediarating] = UNSET
    enclosure: Union[Unset, 'VideosForXMLItemEnclosure'] = UNSET
    mediagroup: Union[Unset, list[Union['MRSSGroupContent', 'MRSSPeerLink']]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mediacommunity: Union[Unset, VideosForXMLItemMediacommunity]
        ...
        mediarating: Union[Unset, VideosForXMLItemMediarating]
        ...
        enclosure: Union[Unset, VideosForXMLItemEnclosure]
        ...
        for mediagroup_item_data in (_mediagroup or []):
            def _parse_mediagroup_item(data: object) -> Union['MRSSGroupContent', 'MRSSPeerLink']:
                try:

...
if TYPE_CHECKING:
  from ..models.server_stats_videos_redundancy_item import ServerStatsVideosRedundancyItem
...
class ServerStats:
    ...
    total_users: Union[Unset, float] = UNSET
    total_daily_active_users: Union[Unset, float] = UNSET
    total_weekly_active_users: Union[Unset, float] = UNSET
    total_monthly_active_users: Union[Unset, float] = UNSET
    total_moderators: Union[Unset, float] = UNSET
    total_admins: Union[Unset, float] = UNSET
    total_local_videos: Union[Unset, float] = UNSET
    total_local_video_views: Union[Unset, float] = UNSET
    total_local_video_comments: Union[Unset, float] = UNSET
    total_local_video_files_size: Union[Unset, float] = UNSET
    total_videos: Union[Unset, float] = UNSET
    total_video_comments: Union[Unset, float] = UNSET
    total_local_video_channels: Union[Unset, float] = UNSET
    total_local_daily_active_video_channels: Union[Unset, float] = UNSET
    total_local_weekly_active_video_channels: Union[Unset, float] = UNSET
    total_local_monthly_active_video_channels: Union[Unset, float] = UNSET
    total_local_playlists: Union[Unset, float] = UNSET
    total_instance_followers: Union[Unset, float] = UNSET
    total_instance_following: Union[Unset, float] = UNSET
    videos_redundancy: Union[Unset, list['ServerStatsVideosRedundancyItem']] = UNSET
    total_activity_pub_messages_processed: Union[Unset, float] = UNSET
    total_activity_pub_messages_successes: Union[Unset, float] = UNSET
    total_activity_pub_messages_errors: Union[Unset, float] = UNSET
    activity_pub_messages_processed_per_second: Union[Unset, float] = UNSET
    total_activity_pub_messages_waiting: Union[Unset, float] = UNSET
    average_registration_request_response_time_ms: Union[Unset, float] = UNSET
    total_registration_requests_processed: Union[Unset, float] = UNSET
    total_registration_requests: Union[Unset, float] = UNSET
    average_abuse_response_time_ms: Union[Unset, float] = UNSET
    total_abuses_processed: Union[Unset, float] = UNSET
    total_abuses: Union[Unset, float] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        total_local_daily_active_video_channels = self.total_local_daily_active_video_channels

        total_local_weekly_active_video_channels = self.total_local_weekly_active_video_channels

        total_local_monthly_active_video_channels = self.total_local_monthly_active_video_channels
        ...
        videos_redundancy: Union[Unset, list[dict[str, Any]]] = UNSET
        ...
        total_activity_pub_messages_processed = self.total_activity_pub_messages_processed

        total_activity_pub_messages_successes = self.total_activity_pub_messages_successes

        total_activity_pub_messages_errors = self.total_activity_pub_messages_errors

        activity_pub_messages_processed_per_second = self.activity_pub_messages_processed_per_second

        total_activity_pub_messages_waiting = self.total_activity_pub_messages_waiting

        average_registration_request_response_time_ms = self.average_registration_request_response_time_ms

        total_registration_requests_processed = self.total_registration_requests_processed
        ...
        if total_local_daily_active_video_channels is not UNSET:
            field_dict["totalLocalDailyActiveVideoChannels"] = total_local_daily_active_video_channels
        if total_local_weekly_active_video_channels is not UNSET:
            field_dict["totalLocalWeeklyActiveVideoChannels"] = total_local_weekly_active_video_channels
        if total_local_monthly_active_video_channels is not UNSET:
            field_dict["totalLocalMonthlyActiveVideoChannels"] = total_local_monthly_active_video_channels
        ...
        if total_activity_pub_messages_processed is not UNSET:
            field_dict["totalActivityPubMessagesProcessed"] = total_activity_pub_messages_processed
        if total_activity_pub_messages_successes is not UNSET:
            field_dict["totalActivityPubMessagesSuccesses"] = total_activity_pub_messages_successes
        if total_activity_pub_messages_errors is not UNSET:
            field_dict["totalActivityPubMessagesErrors"] = total_activity_pub_messages_errors
        if activity_pub_messages_processed_per_second is not UNSET:
            field_dict["activityPubMessagesProcessedPerSecond"] = activity_pub_messages_processed_per_second
        if total_activity_pub_messages_waiting is not UNSET:
            field_dict["totalActivityPubMessagesWaiting"] = total_activity_pub_messages_waiting
        if average_registration_request_response_time_ms is not UNSET:
            field_dict["averageRegistrationRequestResponseTimeMs"] = average_registration_request_response_time_ms
        if total_registration_requests_processed is not UNSET:
            field_dict["totalRegistrationRequestsProcessed"] = total_registration_requests_processed
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        total_local_daily_active_video_channels = d.pop("totalLocalDailyActiveVideoChannels", UNSET)

        total_local_weekly_active_video_channels = d.pop("totalLocalWeeklyActiveVideoChannels", UNSET)

        total_local_monthly_active_video_channels = d.pop("totalLocalMonthlyActiveVideoChannels", UNSET)
        ...
        for videos_redundancy_item_data in (_videos_redundancy or []):
            videos_redundancy_item = ServerStatsVideosRedundancyItem.from_dict(videos_redundancy_item_data)
        ...
        total_activity_pub_messages_processed = d.pop("totalActivityPubMessagesProcessed", UNSET)

        total_activity_pub_messages_successes = d.pop("totalActivityPubMessagesSuccesses", UNSET)

        total_activity_pub_messages_errors = d.pop("totalActivityPubMessagesErrors", UNSET)

        activity_pub_messages_processed_per_second = d.pop("activityPubMessagesProcessedPerSecond", UNSET)

        total_activity_pub_messages_waiting = d.pop("totalActivityPubMessagesWaiting", UNSET)

        average_registration_request_response_time_ms = d.pop("averageRegistrationRequestResponseTimeMs", UNSET)

        total_registration_requests_processed = d.pop("totalRegistrationRequestsProcessed", UNSET)

...
if TYPE_CHECKING:
  from ..models.server_config_views_views_watching_interval import ServerConfigViewsViewsWatchingInterval
...
class ServerConfigViewsViews:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.server_config_views_views_watching_interval import ServerConfigViewsViewsWatchingInterval
        watching_interval: Union[Unset, dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_watching_interval,  Unset):
            ...
            watching_interval = ServerConfigViewsViewsWatchingInterval.from_dict(_watching_interval)

...
if TYPE_CHECKING:
  from ..models.live_video_session_response_replay_video import LiveVideoSessionResponseReplayVideo
...
class LiveVideoSessionResponse:
    ...
    error: Union[Unset, LiveVideoSessionResponseError] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        replay_video: Union[Unset, dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        error: Union[Unset, LiveVideoSessionResponseError]
        ...
        replay_video: Union[Unset, LiveVideoSessionResponseReplayVideo]

...
if TYPE_CHECKING:
  from ..models.server_config_custom_auto_blacklist_videos_of_users import ServerConfigCustomAutoBlacklistVideosOfUsers
...
@_attrs_define
class ServerConfigCustomAutoBlacklistVideos:
    """ 
        Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.server_config_custom_auto_blacklist_videos_of_users import ServerConfigCustomAutoBlacklistVideosOfUsers
        of_users: Union[Unset, dict[str, Any]] = UNSET

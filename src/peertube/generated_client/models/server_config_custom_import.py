...
if TYPE_CHECKING:
  from ..models.server_config_custom_import_video_channel_synchronization import ServerConfigCustomImportVideoChannelSynchronization
  from ..models.server_config_custom_import_videos import ServerConfigCustomImportVideos
...
class ServerConfigCustomImport:
    ...
    video_channel_synchronization: Union[Unset, 'ServerConfigCustomImportVideoChannelSynchronization'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_video_channel_synchronization,  Unset):
            ...
            video_channel_synchronization = ServerConfigCustomImportVideoChannelSynchronization.from_dict(_video_channel_synchronization)

...
if TYPE_CHECKING:
  from ..models.post_api_v1_watched_words_accounts_account_name_lists_response_200_watched_words_list import PostApiV1WatchedWordsAccountsAccountNameListsResponse200WatchedWordsList
...
class PostApiV1WatchedWordsAccountsAccountNameListsResponse200:
    ...
    watched_words_list: Union[Unset, 'PostApiV1WatchedWordsAccountsAccountNameListsResponse200WatchedWordsList'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_watched_words_list,  Unset):
            ...
            watched_words_list = PostApiV1WatchedWordsAccountsAccountNameListsResponse200WatchedWordsList.from_dict(_watched_words_list)

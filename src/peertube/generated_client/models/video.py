...
class Video:
    ...
    live_schedules: Union[Unset, list['LiveSchedule']] = UNSET
    created_at: Union[Unset, datetime.datetime] = UNSET
    published_at: Union[Unset, datetime.datetime] = UNSET
    updated_at: Union[Unset, datetime.datetime] = UNSET
    originally_published_at: Union[None, Unset, datetime.datetime] = UNSET
    ...
    truncated_description: Union[None, Unset, str] = UNSET
    duration: Union[Unset, int] = UNSET
    aspect_ratio: Union[None, Unset, float] = UNSET
    is_local: Union[Unset, bool] = UNSET
    name: Union[Unset, str] = UNSET
    thumbnail_path: Union[Unset, str] = UNSET
    preview_path: Union[Unset, str] = UNSET
    embed_path: Union[Unset, str] = UNSET
    views: Union[Unset, int] = UNSET
    likes: Union[Unset, int] = UNSET
    dislikes: Union[Unset, int] = UNSET
    comments: Union[Unset, int] = UNSET
    nsfw: Union[Unset, bool] = UNSET
    nsfw_flags: Union[Unset, NSFWFlag] = UNSET
    nsfw_summary: Union[Unset, str] = UNSET
    wait_transcoding: Union[None, Unset, bool] = UNSET
    state: Union[Unset, 'VideoStateConstant'] = UNSET
    scheduled_update: Union['VideoScheduledUpdate', None, Unset] = UNSET
    blacklisted: Union[None, Unset, bool] = UNSET
    blacklisted_reason: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        live_schedules: Union[Unset, list[dict[str, Any]]] = UNSET
        ...
        originally_published_at: Union[None, Unset, str]
        ...
        licence: Union[Unset, dict[str, Any]] = UNSET
        ...
        privacy: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.privacy, Unset):
            privacy = self.privacy.to_dict()

        truncated_description: Union[None, Unset, str]
        ...
        aspect_ratio: Union[None, Unset, float]
        ...
        nsfw_flags: Union[Unset, int] = UNSET
        ...
        scheduled_update: Union[None, Unset, dict[str, Any]]
        ...
        user_history: Union[None, Unset, dict[str, Any]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_originally_published_at(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
        ...
        originally_published_at = _parse_originally_published_at(d.pop("originallyPublishedAt", UNSET))
        ...
        def _parse_truncated_description(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        truncated_description = _parse_truncated_description(d.pop("truncatedDescription", UNSET))


        duration = d.pop("duration", UNSET)

        def _parse_aspect_ratio(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_wait_transcoding(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_scheduled_update(data: object) -> Union['VideoScheduledUpdate', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union['VideoScheduledUpdate', None, Unset], data)

        scheduled_update = _parse_scheduled_update(d.pop("scheduledUpdate", UNSET))


        def _parse_blacklisted(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_blacklisted_reason(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_user_history(data: object) -> Union['VideoUserHistoryType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union['VideoUserHistoryType0', None, Unset], data)

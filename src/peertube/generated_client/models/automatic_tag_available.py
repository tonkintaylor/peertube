...
if TYPE_CHECKING:
  from ..models.automatic_tag_available_available_item import AutomaticTagAvailableAvailableItem
...
class AutomaticTagAvailable:
    ...
    available: Union[Unset, list['AutomaticTagAvailableAvailableItem']] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.automatic_tag_available_available_item import AutomaticTagAvailableAvailableItem
        available: Union[Unset, list[dict[str, Any]]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for available_item_data in (_available or []):
            available_item = AutomaticTagAvailableAvailableItem.from_dict(available_item_data)

...
class UserViewingVideo:
    ...
    current_time: int
    view_event: Union[Unset, UserViewingVideoViewEvent] = UNSET
    session_id: Union[Unset, str] = UNSET
    client: Union[Unset, str] = UNSET
    device: Union[Unset, VideoStatsUserAgentDevice] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        view_event: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        view_event: Union[Unset, UserViewingVideoViewEvent]

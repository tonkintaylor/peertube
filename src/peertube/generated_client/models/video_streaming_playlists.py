...
from ..models.video_streaming_playlists_type import VideoStreamingPlaylistsType
from ..types import UNSET, Unset
...
class VideoStreamingPlaylists:
    ...
    type_: Union[Unset, VideoStreamingPlaylistsType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, VideoStreamingPlaylistsType]

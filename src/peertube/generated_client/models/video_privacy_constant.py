...
@_attrs_define
class VideoPrivacyConstant:
    """ 
        Attributes:
            id (Union[Unset, VideoPrivacySet]): privacy id of the video (see
                [/videos/privacies](#operation/getVideoPrivacyPolicies))
            label (Union[Unset, str]):
     """

    id: Union[Unset, VideoPrivacySet] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _id = d.pop("id", UNSET)
        id: Union[Unset, VideoPrivacySet]

...
class UserRegistration:
    ...
    registration_reason: Union[Unset, str] = UNSET
    moderation_response: Union[None, Unset, str] = UNSET
    username: Union[Unset, str] = UNSET
    email: Union[Unset, str] = UNSET
    email_verified: Union[Unset, bool] = UNSET
    account_display_name: Union[Unset, str] = UNSET
    channel_handle: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_moderation_response(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
        ...
        moderation_response = _parse_moderation_response(d.pop("moderationResponse", UNSET))
        ...
        def _parse_user(data: object) -> Union['UserRegistrationUserType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union['UserRegistrationUserType0', None, Unset], data)

...
if TYPE_CHECKING:
  from ..models.server_config_followings_instance_auto_follow_index import ServerConfigFollowingsInstanceAutoFollowIndex
...
class ServerConfigFollowingsInstance:
    ...
    auto_follow_index: Union[Unset, 'ServerConfigFollowingsInstanceAutoFollowIndex'] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.server_config_followings_instance_auto_follow_index import ServerConfigFollowingsInstanceAutoFollowIndex
        auto_follow_index: Union[Unset, dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_auto_follow_index,  Unset):
            ...
            auto_follow_index = ServerConfigFollowingsInstanceAutoFollowIndex.from_dict(_auto_follow_index)

...
from ..models.video_import_state_constant_id import VideoImportStateConstantId
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="VideoImportStateConstant")
...
class VideoImportStateConstant:
    ...
    id: Union[Unset, VideoImportStateConstantId] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _id = d.pop("id", UNSET)
        id: Union[Unset, VideoImportStateConstantId]
        if isinstance(_id,  Unset):
            id = UNSET
        else:
            id = VideoImportStateConstantId(_id)

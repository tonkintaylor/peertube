...
if TYPE_CHECKING:
  from ..models.server_config_custom_instance_customizations import ServerConfigCustomInstanceCustomizations
  from ..models.server_config_custom_instance_support import ServerConfigCustomInstanceSupport
  from ..models.server_config_custom_instance_social import ServerConfigCustomInstanceSocial
...
class ServerConfigCustomInstance:
    ...
    code_of_conduct: Union[Unset, str] = UNSET
    creation_reason: Union[Unset, str] = UNSET
    moderation_information: Union[Unset, str] = UNSET
    administrator: Union[Unset, str] = UNSET
    maintenance_lifetime: Union[Unset, str] = UNSET
    business_model: Union[Unset, str] = UNSET
    hardware_information: Union[Unset, str] = UNSET
    languages: Union[Unset, list[str]] = UNSET
    categories: Union[Unset, list[float]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_customizations,  Unset):
            ...
            customizations = ServerConfigCustomInstanceCustomizations.from_dict(_customizations)

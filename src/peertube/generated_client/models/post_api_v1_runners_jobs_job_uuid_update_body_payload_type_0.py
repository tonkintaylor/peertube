...
from ..models.post_api_v1_runners_jobs_job_uuid_update_body_payload_type_0_type import PostApiV1RunnersJobsJobUUIDUpdateBodyPayloadType0Type
...
class PostApiV1RunnersJobsJobUUIDUpdateBodyPayloadType0:
    ...
    type_: Union[Unset, PostApiV1RunnersJobsJobUUIDUpdateBodyPayloadType0Type] = UNSET
    master_playlist_file: Union[Unset, File] = UNSET
    resolution_playlist_file: Union[Unset, File] = UNSET
    resolution_playlist_filename: Union[Unset, str] = UNSET
    video_chunk_file: Union[Unset, File] = UNSET
    video_chunk_filename: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        video_chunk_file: Union[Unset, FileTypes] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_master_playlist_file,  Unset):
            ...
            master_playlist_file = File(
             payload = BytesIO(_master_playlist_file)
        )
        ...
        if isinstance(_resolution_playlist_file,  Unset):
            ...
            resolution_playlist_file = File(
             payload = BytesIO(_resolution_playlist_file)
        )
        ...
        if isinstance(_video_chunk_file,  Unset):
            ...
            video_chunk_file = File(
             payload = BytesIO(_video_chunk_file)
        )

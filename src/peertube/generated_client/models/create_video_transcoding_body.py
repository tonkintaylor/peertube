...
from ..models.create_video_transcoding_body_transcoding_type import CreateVideoTranscodingBodyTranscodingType
from ..types import UNSET, Unset
...
class CreateVideoTranscodingBody:
    ...
    transcoding_type: CreateVideoTranscodingBodyTranscodingType
    force_transcoding: Union[Unset, bool] = False
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        transcoding_type = CreateVideoTranscodingBodyTranscodingType(d.pop("transcodingType"))

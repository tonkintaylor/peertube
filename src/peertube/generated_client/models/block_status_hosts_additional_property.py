...
T = TypeVar("T", bound="BlockStatusHostsAdditionalProperty")



@_attrs_define
class BlockStatusHostsAdditionalProperty:
    """ 
        Attributes:
    ...
    blocked_by_server: Union[Unset, bool] = UNSET
    blocked_by_user: Union[Unset, bool] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return block_status_hosts_additional_property

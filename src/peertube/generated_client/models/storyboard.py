...
class Storyboard:
    ...
    storyboard_path: Union[Unset, str] = UNSET
    total_height: Union[Unset, int] = UNSET
    total_width: Union[Unset, int] = UNSET
    sprite_height: Union[Unset, int] = UNSET
    sprite_width: Union[Unset, int] = UNSET
    sprite_duration: Union[Unset, int] = UNSET

...
class VideoImport:
    ...
    torrentfile: Union[Unset, File] = UNSET
    torrent_name: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        torrentfile: Union[Unset, FileTypes] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        torrentfile: Union[Unset, File]
        if isinstance(_torrentfile,  Unset):
            torrentfile = UNSET
        else:
            torrentfile = File(
             payload = BytesIO(_torrentfile)
        )
        ...
        def _parse_video(data: object) -> Union['Video', None, Unset]:
            ...
            try:
                ...
                pass
            return cast(Union['Video', None, Unset], data)

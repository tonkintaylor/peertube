...
from ..models.user_export_state import UserExportState
from ..types import UNSET, Unset
...
class ListUserExportsResponse200State:
    ...
    id: Union[Unset, UserExportState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _id = d.pop("id", UNSET)
        id: Union[Unset, UserExportState]
        ...
        list_user_exports_response_200_state = cls(
            id=id,
            label=label,
        )

...
if TYPE_CHECKING:
  from ..models.video_stats_user_agent_clients_item import VideoStatsUserAgentClientsItem
  from ..models.video_stats_user_agent_operating_system_item import VideoStatsUserAgentOperatingSystemItem
  from ..models.video_stats_user_agent_devices_item import VideoStatsUserAgentDevicesItem
...
class VideoStatsUserAgent:
    ...
    clients: Union[Unset, list['VideoStatsUserAgentClientsItem']] = UNSET
    devices: Union[Unset, list['VideoStatsUserAgentDevicesItem']] = UNSET
    operating_system: Union[Unset, list['VideoStatsUserAgentOperatingSystemItem']] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        operating_system: Union[Unset, list[dict[str, Any]]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for operating_system_item_data in (_operating_system or []):
            operating_system_item = VideoStatsUserAgentOperatingSystemItem.from_dict(operating_system_item_data)

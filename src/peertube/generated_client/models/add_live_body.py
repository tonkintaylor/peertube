...
class AddLiveBody:
    ...
    previewfile: Union[Unset, File] = UNSET
    ...
    nsfw_summary: Union[Unset, Any] = UNSET
    nsfw_flags: Union[Unset, NSFWFlag] = UNSET
    tags: Union[Unset, list[str]] = UNSET
    comments_enabled: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        previewfile: Union[Unset, FileTypes] = UNSET
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.save_replay, Unset):
            files.append(("saveReplay", (None, str(self.save_replay).encode(), "text/plain")))



        if not isinstance(self.replay_settings, Unset):
            files.append(("replaySettings", (None, json.dumps( self.replay_settings.to_dict()).encode(), "application/json")))



        if not isinstance(self.permanent_live, Unset):
            files.append(("permanentLive", (None, str(self.permanent_live).encode(), "text/plain")))



        if not isinstance(self.latency_mode, Unset):
            files.append(("latencyMode",  (None, str(self.latency_mode.value).encode(), "text/plain")))
        ...
        if not isinstance(self.nsfw_summary, Unset):
            files.append(("nsfwSummary", (None, str(self.nsfw_summary).encode(), "text/plain")))



        if not isinstance(self.nsfw_flags, Unset):
            files.append(("nsfwFlags",  (None, str(self.nsfw_flags.value).encode(), "text/plain")))
        ...
        if not isinstance(self.comments_enabled, Unset):
            files.append(("commentsEnabled", (None, str(self.comments_enabled).encode(), "text/plain")))



        if not isinstance(self.comments_policy, Unset):
            files.append(("commentsPolicy",  (None, str(self.comments_policy.value).encode(), "text/plain")))



        if not isinstance(self.download_enabled, Unset):
            files.append(("downloadEnabled", (None, str(self.download_enabled).encode(), "text/plain")))



        if not isinstance(self.schedules, Unset):
            for schedules_item_element in self.schedules:
                files.append(("schedules", (None, json.dumps( schedules_item_element.to_dict()).encode(), "application/json")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        previewfile: Union[Unset, File]
        if isinstance(_previewfile,  Unset):
            previewfile = UNSET
        else:
            previewfile = File(
             payload = BytesIO(_previewfile)
        )

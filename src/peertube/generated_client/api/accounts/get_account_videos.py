...
def _get_kwargs(
    ...
    *,
    ...
    skip_count: Union[Unset, GetAccountVideosSkipCount] = GetAccountVideosSkipCount.FALSE,
    sort: Union[Unset, GetAccountVideosSort] = UNSET,
    nsfw: Union[Unset, GetAccountVideosNsfw] = UNSET,
    ...
    include: Union[Unset, GetAccountVideosInclude] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/accounts/{name}/videos".format(name=name,),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        skip_count (Union[Unset, GetAccountVideosSkipCount]):  Default:
        ...
        nsfw (Union[Unset, GetAccountVideosNsfw]):
        ...
        include (Union[Unset, GetAccountVideosInclude]):

...
def _get_kwargs(
    *,
    ...
    predefined_reason: Union[Unset, list[PredefinedAbuseReasonsItem]] = UNSET,
    search: Union[Unset, str] = UNSET,
    state: Union[Unset, AbuseStateSet] = UNSET,
    search_reporter: Union[Unset, str] = UNSET,
    search_reportee: Union[Unset, str] = UNSET,
    search_video: Union[Unset, str] = UNSET,
    search_video_channel: Union[Unset, str] = UNSET,
    video_is: Union[Unset, GetAbusesVideoIs] = UNSET,
    filter_: Union[Unset, GetAbusesFilter] = UNSET,
    start: Union[Unset, int] = UNSET,
    count: Union[Unset, int] = 15,
    sort: Union[Unset, GetAbusesSort] = UNSET,
    ...
    json_predefined_reason: Union[Unset, list[str]] = UNSET
    if not isinstance(predefined_reason, Unset):
        ...
        for componentsschemas_predefined_abuse_reasons_item_data in predefined_reason:
            componentsschemas_predefined_abuse_reasons_item = componentsschemas_predefined_abuse_reasons_item_data.value
            json_predefined_reason.append(componentsschemas_predefined_abuse_reasons_item)
    ...
    json_video_is: Union[Unset, str] = UNSET

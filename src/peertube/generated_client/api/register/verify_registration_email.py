...
from ...models.verify_registration_email_body import VerifyRegistrationEmailBody
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/users/registrations/{registration_id}/verify-email".format(registration_id=registration_id,),
    }

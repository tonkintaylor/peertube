...
def _get_kwargs(
    filename: str,
    *,
    video_file_token: Union[Unset, str] = UNSET,
    reinject_video_file_token: Union[Unset, bool] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/static/streaming-playlists/hls/private/{filename}".format(filename=filename,),
        "params": params,
    }

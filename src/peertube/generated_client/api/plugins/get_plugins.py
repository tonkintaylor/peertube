...
def _get_kwargs(
    *,
    ...
    uninstalled: Union[Unset, bool] = UNSET,
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[PluginResponse]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[PluginResponse]:
    return Response(

...
from ...models.get_syndicated_subscription_videos_format import GetSyndicatedSubscriptionVideosFormat
from ...models.get_syndicated_subscription_videos_include import GetSyndicatedSubscriptionVideosInclude
from ...models.get_syndicated_subscription_videos_nsfw import GetSyndicatedSubscriptionVideosNsfw
...
def _get_kwargs(
    ...
    *,
    ...
    nsfw: Union[Unset, GetSyndicatedSubscriptionVideosNsfw] = UNSET,
    is_local: Union[Unset, bool] = UNSET,
    include: Union[Unset, GetSyndicatedSubscriptionVideosInclude] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/feeds/subscriptions.{format_}".format(format_=format_,),
        "params": params,
    }

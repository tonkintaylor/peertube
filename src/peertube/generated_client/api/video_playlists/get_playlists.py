...
from ...models.get_playlists_response_200 import GetPlaylistsResponse200
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[GetPlaylistsResponse200]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[GetPlaylistsResponse200]:
    return Response(
...
) -> Optional[GetPlaylistsResponse200]:
    """ List video playlists

...
from ...models.video_replace_source_request_resumable import VideoReplaceSourceRequestResumable
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/videos/{id}/source/replace-resumable".format(id=id,),
    }

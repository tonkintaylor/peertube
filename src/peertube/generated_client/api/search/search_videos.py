...
def _get_kwargs(
    *,
    search: str,
    uuids: Union[Unset, Any] = UNSET,
    search_target: Union[Unset, SearchVideosSearchTarget] = UNSET,
    start: Union[Unset, int] = UNSET,
    count: Union[Unset, int] = 15,
    skip_count: Union[Unset, SearchVideosSkipCount] = SearchVideosSkipCount.FALSE,
    sort: Union[Unset, SearchVideosSort] = UNSET,
    nsfw: Union[Unset, SearchVideosNsfw] = UNSET,
    ...
    include: Union[Unset, SearchVideosInclude] = UNSET,
    ...
    originally_published_start_date: Union[Unset, datetime.datetime] = UNSET,
    originally_published_end_date: Union[Unset, datetime.datetime] = UNSET,
    duration_min: Union[Unset, int] = UNSET,
    duration_max: Union[Unset, int] = UNSET,
    ...
    json_originally_published_start_date: Union[Unset, str] = UNSET
    if not isinstance(originally_published_start_date, Unset):
        json_originally_published_start_date = originally_published_start_date.isoformat()
    params["originallyPublishedStartDate"] = json_originally_published_start_date

    json_originally_published_end_date: Union[Unset, str] = UNSET
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, VideoListResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, VideoListResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        search_target (Union[Unset, SearchVideosSearchTarget]):
        ...
        nsfw (Union[Unset, SearchVideosNsfw]):
        ...
        include (Union[Unset, SearchVideosInclude]):
        ...
        originally_published_start_date (Union[Unset, datetime.datetime]):
        originally_published_end_date (Union[Unset, datetime.datetime]):
        duration_min (Union[Unset, int]):
        duration_max (Union[Unset, int]):
...
) -> Optional[Union[Any, VideoListResponse]]:
    """ Search videos

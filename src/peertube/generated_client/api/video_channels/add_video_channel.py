...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[AddVideoChannelResponse200]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[AddVideoChannelResponse200]:
    return Response(
...
) -> Optional[AddVideoChannelResponse200]:
    """ Create a video channel

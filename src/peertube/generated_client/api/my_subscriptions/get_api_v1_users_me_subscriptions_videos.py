...
from ...models.get_api_v1_users_me_subscriptions_videos_include import GetApiV1UsersMeSubscriptionsVideosInclude
from ...models.get_api_v1_users_me_subscriptions_videos_nsfw import GetApiV1UsersMeSubscriptionsVideosNsfw
from ...models.get_api_v1_users_me_subscriptions_videos_skip_count import GetApiV1UsersMeSubscriptionsVideosSkipCount
from ...models.get_api_v1_users_me_subscriptions_videos_sort import GetApiV1UsersMeSubscriptionsVideosSort
...
def _get_kwargs(
    *,
    ...
    skip_count: Union[Unset, GetApiV1UsersMeSubscriptionsVideosSkipCount] = GetApiV1UsersMeSubscriptionsVideosSkipCount.FALSE,
    sort: Union[Unset, GetApiV1UsersMeSubscriptionsVideosSort] = UNSET,
    nsfw: Union[Unset, GetApiV1UsersMeSubscriptionsVideosNsfw] = UNSET,
    ...
    include: Union[Unset, GetApiV1UsersMeSubscriptionsVideosInclude] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        skip_count (Union[Unset, GetApiV1UsersMeSubscriptionsVideosSkipCount]):  Default:
            GetApiV1UsersMeSubscriptionsVideosSkipCount.FALSE.
        sort (Union[Unset, GetApiV1UsersMeSubscriptionsVideosSort]): Sort videos by criteria
            (prefixing with `-` means `DESC` order):
        ...
        nsfw (Union[Unset, GetApiV1UsersMeSubscriptionsVideosNsfw]):
        ...
        include (Union[Unset, GetApiV1UsersMeSubscriptionsVideosInclude]):

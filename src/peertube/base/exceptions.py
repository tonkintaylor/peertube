...
class AuthenticationError(PeerTubeError):
    ...
    def __init__(self, message: str = "Authentication failed") -> None:
        super().__init__(message, status_code=codes.UNAUTHORIZED)
...
class NotFoundError(PeerTubeError):
    ...
    def __init__(self, message: str = "Resource not found") -> None:
        super().__init__(message, status_code=codes.NOT_FOUND)
...
class ValidationError(PeerTubeError):
    ...
    def __init__(
        ...
        super().__init__(message, status_code=codes.BAD_REQUEST, details=details)
...
class ForbiddenError(PeerTubeError):
    ...
    def __init__(self, message: str = "Access forbidden") -> None:
        super().__init__(message, status_code=codes.FORBIDDEN)

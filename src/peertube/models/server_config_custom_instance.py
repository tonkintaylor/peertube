...
class ServerConfigCustomInstance:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        server_config_custom_instance=cls(
            name=name, short_description=short_description, description=description, terms=terms, code_of_conduct=code_of_conduct, creation_reason=creation_reason, moderation_information=moderation_information, administrator=administrator, maintenance_lifetime=maintenance_lifetime, business_model=business_model, hardware_information=hardware_information, languages=languages, categories=categories, is_nsfw=is_nsfw, default_nsfw_policy=default_nsfw_policy, server_country=server_country, support=support, social=social, default_client_route=default_client_route, customizations=customizations)

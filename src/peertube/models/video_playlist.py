...
class VideoPlaylist:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        video_playlist=cls(
            id=id, uuid=uuid, short_uuid=short_uuid, created_at=created_at, updated_at=updated_at, description=description, display_name=display_name, is_local=is_local, video_length=video_length, thumbnail_path=thumbnail_path, privacy=privacy, type_=type_, owner_account=owner_account, video_channel=video_channel, video_channel_position=video_channel_position)

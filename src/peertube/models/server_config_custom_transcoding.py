...
class ServerConfigCustomTranscoding:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        server_config_custom_transcoding=cls(
            enabled=enabled, original_file=original_file, allow_additional_extensions=allow_additional_extensions, allow_audio_files=allow_audio_files, threads=threads, concurrency=concurrency, profile=profile, resolutions=resolutions, web_videos=web_videos, hls=hls)

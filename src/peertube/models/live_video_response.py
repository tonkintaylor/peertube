...
class LiveVideoResponse:
    ...
    rtmp_url: Unset | str=UNSET
    rtmps_url: Unset | str=UNSET
    stream_key: Unset | str=UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        live_video_response=cls(
            rtmp_url=rtmp_url, rtmps_url=rtmps_url, stream_key=stream_key, save_replay=save_replay, replay_settings=replay_settings, permanent_live=permanent_live, latency_mode=latency_mode, schedules=schedules)

...
class UserRegistrationRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update(
            {
                "username": username, "password": password, "email": email, "registrationReason": registration_reason, }
        )
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        user_registration_request=cls(
            username=username, password=password, email=email, registration_reason=registration_reason, display_name=display_name, channel=channel)

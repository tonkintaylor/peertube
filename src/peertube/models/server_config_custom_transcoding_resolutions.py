...
class ServerConfigCustomTranscodingResolutions:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        server_config_custom_transcoding_resolutions=cls(
            field_0p=field_0p, field_144p=field_144p, field_240p=field_240p, field_360p=field_360p, field_480p=field_480p, field_720p=field_720p, field_1080p=field_1080p, field_1440p=field_1440p, field_2160p=field_2160p)

...
if TYPE_CHECKING:
    ...
    from ..models.server_config_custom_defaults_player import (
        ServerConfigCustomDefaultsPlayer,
    )
    from ..models.server_config_custom_defaults_publish import (
...
class ServerConfigCustomDefaults:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.server_config_custom_defaults_p2p import (

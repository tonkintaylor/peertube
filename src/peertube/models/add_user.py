...
class AddUser:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        add_user=cls(
            username=username, password=password, email=email, role=role, video_quota=video_quota, video_quota_daily=video_quota_daily, channel_name=channel_name, admin_flags=admin_flags)

...
class ServerStats:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        server_stats=cls(
            total_users=total_users, total_daily_active_users=total_daily_active_users, total_weekly_active_users=total_weekly_active_users, total_monthly_active_users=total_monthly_active_users, total_moderators=total_moderators, total_admins=total_admins, total_local_videos=total_local_videos, total_local_video_views=total_local_video_views, total_local_video_comments=total_local_video_comments, total_local_video_files_size=total_local_video_files_size, total_videos=total_videos, total_video_comments=total_video_comments, total_local_video_channels=total_local_video_channels, total_local_daily_active_video_channels=total_local_daily_active_video_channels, total_local_weekly_active_video_channels=total_local_weekly_active_video_channels, total_local_monthly_active_video_channels=total_local_monthly_active_video_channels, total_local_playlists=total_local_playlists, total_instance_followers=total_instance_followers, total_instance_following=total_instance_following, videos_redundancy=videos_redundancy, total_activity_pub_messages_processed=total_activity_pub_messages_processed, total_activity_pub_messages_successes=total_activity_pub_messages_successes, total_activity_pub_messages_errors=total_activity_pub_messages_errors, activity_pub_messages_processed_per_second=activity_pub_messages_processed_per_second, total_activity_pub_messages_waiting=total_activity_pub_messages_waiting, average_registration_request_response_time_ms=average_registration_request_response_time_ms, total_registration_requests_processed=total_registration_requests_processed, total_registration_requests=total_registration_requests, average_abuse_response_time_ms=average_abuse_response_time_ms, total_abuses_processed=total_abuses_processed, total_abuses=total_abuses)

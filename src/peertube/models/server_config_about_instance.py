...
class ServerConfigAboutInstance:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        server_config_about_instance=cls(
            name=name, short_description=short_description, description=description, terms=terms, code_of_conduct=code_of_conduct, hardware_information=hardware_information, creation_reason=creation_reason, moderation_information=moderation_information, administrator=administrator, maintenance_lifetime=maintenance_lifetime, business_model=business_model, languages=languages, categories=categories, avatars=avatars, banners=banners)

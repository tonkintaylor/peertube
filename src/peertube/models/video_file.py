...
class VideoFile:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        video_file=cls(
            id=id, magnet_uri=magnet_uri, resolution=resolution, size=size, torrent_url=torrent_url, torrent_download_url=torrent_download_url, file_url=file_url, playlist_url=playlist_url, file_download_url=file_download_url, fps=fps, width=width, height=height, metadata_url=metadata_url, has_audio=has_audio, has_video=has_video, storage=storage)

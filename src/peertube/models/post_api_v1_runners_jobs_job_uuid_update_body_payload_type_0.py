...
class PostApiV1RunnersJobsJobUUIDUpdateBodyPayloadType0:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        post_api_v1_runners_jobs_job_uuid_update_body_payload_type_0=cls(
            type_=type_, master_playlist_file=master_playlist_file, resolution_playlist_file=resolution_playlist_file, resolution_playlist_filename=resolution_playlist_filename, video_chunk_file=video_chunk_file, video_chunk_filename=video_chunk_filename)

...
class AddPlaylistBody:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.video_channel_id, Unset):
            files.append(
                (
                    "videoChannelId", (None, str(self.video_channel_id).encode(), "text/plain"))
            )
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        add_playlist_body=cls(
            display_name=display_name, thumbnailfile=thumbnailfile, privacy=privacy, description=description, video_channel_id=video_channel_id)

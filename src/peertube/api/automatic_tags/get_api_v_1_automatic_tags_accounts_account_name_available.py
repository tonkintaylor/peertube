...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any]={
        "method": "get", "url": f"/api/v1/automatic-tags/accounts/{account_name}/available", }
...
def sync_detailed(
    account_name: str, *, client: AuthenticatedClient) -> Response[AutomaticTagAvailable]:
...
def sync(
    account_name: str, *, client: AuthenticatedClient) -> AutomaticTagAvailable | None:
    """Get account available auto tags

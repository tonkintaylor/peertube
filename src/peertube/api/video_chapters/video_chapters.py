...
from peertube.models.video_chapters import VideoChapters
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any]={
        "method": "get", "url": f"/api/v1/videos/{id}/chapters", }
...
def sync_detailed(
    id: UUID | int | str, *, client: AuthenticatedClient | Client, x_peertube_video_password: Unset | str=UNSET) -> Response[VideoChapters]:
...
def sync(
    id: UUID | int | str, *, client: AuthenticatedClient | Client, x_peertube_video_password: Unset | str=UNSET) -> VideoChapters | None:
    """Get chapters of a video

...
def _get_kwargs(
    job_uuid: UUID, *, body: PostApiV1RunnersJobsJobUUIDSuccessBody) -> dict[str, Any]:
    headers: dict[str, Any]={}

    _kwargs: dict[str, Any]={
        "method": "post", "url": f"/api/v1/runners/jobs/{job_uuid}/success", }
...
def sync(
    job_uuid: UUID, *, client: AuthenticatedClient | Client, body: PostApiV1RunnersJobsJobUUIDSuccessBody) -> Any | None:
    """Post job success

...
def _get_kwargs(
    *,
    ...
    count: Unset | int = 15,
    skip_count: Unset
    | GetApiV1UsersMeSubscriptionsVideosSkipCount = GetApiV1UsersMeSubscriptionsVideosSkipCount.FALSE,
    sort: Unset | GetApiV1UsersMeSubscriptionsVideosSort = UNSET,
    nsfw: Unset | GetApiV1UsersMeSubscriptionsVideosNsfw = UNSET,
    ...
    include: Unset | GetApiV1UsersMeSubscriptionsVideosInclude = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        nsfw (Union[Unset, GetApiV1UsersMeSubscriptionsVideosNsfw]): Parameter for nsfw.
        ...
        include (Union[Unset, GetApiV1UsersMeSubscriptionsVideosInclude]): Parameter for include.

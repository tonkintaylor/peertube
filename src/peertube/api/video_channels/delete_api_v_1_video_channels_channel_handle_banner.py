...
def _get_kwargs(channel_handle: str) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/api/v1/video-channels/{channel_handle}/banner",
    }
...
def sync_detailed(channel_handle: str, *, client: AuthenticatedClient) -> Response[Any]:
...
def sync(channel_handle: str, *, client: AuthenticatedClient) -> Any | None:
    """Delete channel banner
...
async def asyncio_detailed(
    channel_handle: str, *, client: AuthenticatedClient
) -> Response[Any]:
    """Delete channel banner

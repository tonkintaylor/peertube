...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any]={
        "method": "get", "url": f"/api/v1/accounts/{name}/videos", "params": params, }
...
def sync_detailed(
    ...
    Args:
        ...
        nsfw (Union[Unset, GetAccountVideosNsfw]): Parameter for nsfw.
        ...
        include (Union[Unset, GetAccountVideosInclude]): Parameter for include.

...
def _get_kwargs(
    channel_handle: str, *, body: ReorderVideoPlaylistsOfChannelBody) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any]={
        "method": "post", "url": f"/api/v1/video-channels/{channel_handle}/video-playlists/reorder", }
...
def sync_detailed(
    channel_handle: str, *, client: AuthenticatedClient, body: ReorderVideoPlaylistsOfChannelBody) -> Response[Any]:
...
def sync(
    channel_handle: str, *, client: AuthenticatedClient, body: ReorderVideoPlaylistsOfChannelBody) -> Any | None:
    """Reorder channel playlists

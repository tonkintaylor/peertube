...
def sync_detailed(
    id: UUID | int | str, *, client: AuthenticatedClient, body: list[Union["AddIntro", "AddOutro", "AddWatermark", "Cut"]]) -> Response[Any]:
...
def sync(
    id: UUID | int | str, *, client: AuthenticatedClient, body: list[Union["AddIntro", "AddOutro", "AddWatermark", "Cut"]]) -> Any | None:
    """Create a studio task

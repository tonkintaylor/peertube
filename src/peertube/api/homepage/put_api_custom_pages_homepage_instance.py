...
def _get_kwargs(
    *, body: PutApiV1CustomPagesHomepageInstanceBody) -> dict[str, Any]:
    headers: dict[str, Any]={}

    _kwargs: dict[str, Any]={
        "method": "put", "url": "/api/v1/custom-pages/homepage/instance", }
...
def sync(
    *, client: AuthenticatedClient, body: PutApiV1CustomPagesHomepageInstanceBody) -> Any | None:
    """Set instance custom homepage

...
def _get_kwargs(
    id: int, *, body: ConfirmTwoFactorRequestBody) -> dict[str, Any]:
    headers: dict[str, Any]={}

    _kwargs: dict[str, Any]={
        "method": "post", "url": f"/api/v1/users/{id}/two-factor/confirm-request", }
...
def sync(
    id: int, *, client: AuthenticatedClient, body: ConfirmTwoFactorRequestBody) -> Any | None:
    """Confirm two factor auth

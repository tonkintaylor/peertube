...
def _get_kwargs(
    *, body: Union["AddPluginBodyType0", "AddPluginBodyType1"]) -> dict[str, Any]:
    headers: dict[str, Any]={}

    _kwargs: dict[str, Any]={
        "method": "post", "url": "/api/v1/plugins/install", }
...
def sync_detailed(
    *, client: AuthenticatedClient, body: Union["AddPluginBodyType0", "AddPluginBodyType1"]) -> Response[Any]:
    """Install a plugin
...
def sync(
    *, client: AuthenticatedClient, body: Union["AddPluginBodyType0", "AddPluginBodyType1"]) -> Any | None:
    """Install a plugin

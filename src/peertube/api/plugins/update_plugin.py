...
def _get_kwargs(
    *, body: Union["UpdatePluginBodyType0", "UpdatePluginBodyType1"]) -> dict[str, Any]:
    headers: dict[str, Any]={}

    _kwargs: dict[str, Any]={
        "method": "post", "url": "/api/v1/plugins/update", }
...
def sync_detailed(
    *, client: AuthenticatedClient, body: Union["UpdatePluginBodyType0", "UpdatePluginBodyType1"]) -> Response[Any]:
    """Update a plugin
...
def sync(
    *, client: AuthenticatedClient, body: Union["UpdatePluginBodyType0", "UpdatePluginBodyType1"]) -> Any | None:
    """Update a plugin

...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any]={
        "method": "get", "url": f"/api/v1/plugins/{npm_name}/public-settings", }
...
def sync_detailed(
    npm_name: str, *, client: AuthenticatedClient | Client) -> Response[Any | GetApiV1PluginsNpmNamePublicSettingsResponse200]:
...
def sync(
    npm_name: str, *, client: AuthenticatedClient | Client) -> Any | GetApiV1PluginsNpmNamePublicSettingsResponse200 | None:
    """Get a plugin's public settings

...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get", "url": f"/api/v1/videos/{id}/stats/retention", }
...
def sync_detailed(
    id: UUID | int | str, *, client: AuthenticatedClient) -> Response[VideoStatsRetention]:
...
def sync(
    id: UUID | int | str, *, client: AuthenticatedClient) -> VideoStatsRetention | None:
    """Get retention stats of a video

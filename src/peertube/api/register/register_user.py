...
def _get_kwargs(
    *, body: RegisterUser) -> dict[str, Any]:
...
def sync_detailed(
    *, client: AuthenticatedClient | Client, body: RegisterUser) -> Response[Any]:
    """Register a user
...
def sync(
    *, client: AuthenticatedClient | Client, body: RegisterUser) -> Any | None:
    """Register a user
